...
\begin{longtable}[]{@{}llr@{}}
\caption{Experiment 2 \textbar{} Mediation model comparison}\tabularnewline
\toprule()
& Model & BF \\
\midrule()
\endfirsthead
...
\caption{\label{tab:unnamed-chunk-5}General Correlation Matrix | Experiment 2}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
