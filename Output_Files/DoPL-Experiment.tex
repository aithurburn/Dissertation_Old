...
When investigating dominance, prestige, and leadership motivations with domain-specific risk-taking findings supported the common expectations in the literature. Table 5 shows the interactions with like CI values. Dominance overall explained the relationship between DoPL orientation and preference, specifically (95\% CI b = NA, {[}NA{]}, financial, b = 0.31, {[}0.1 - 0.53{]}, social, b = 0.39, {[}0.18 - 0.61{]}, health and safety, b = 0.41, {[}0.2 - 0.61{]}, and recreational, b = 0.50, {[}0.31 - 0.7{]}) respectively. Full interactions can be found in table 4. Participant age and gender also appeared to affect recreational preference (95\% CI b = -0.71, {[}-1.04 - -0.39{]}, b = 0.23, {[}0.06 - 0.4{]}) respectively.
...
Risk preferences is generally made up of benefits and perceptions of risk. Outside of perceptions and benefits, dominance and males who are dominance oriented were the strongest predictors of likelihood in engaging in a risky situation (95\% CI b = 0.65, {[}0.39 - 0.91{]} and b = -0.49, {[}-0.84 - -0.14{]}). Dominance also appeared to be a strong predictor of perceiving more benefits of engaging in a risky situation (95\% CI b = 0.40, {[}0.13 - 0.68{]}) along with gender where males are more likely to perceive benefits (95\% CI b = -0.56, {[}-0.88 - -0.25{]}).

Alternatiively, prestige appeared to be a stronger predictor of perceiving risks than others along with female participants and female participants that are higher in leadership orientation (95\% CI b = 0.26, {[}-0.03 - 0.55{]}, b = 0.44, {[}0.12 - 0.77{]}, and b = 0.20, {[}-0.17 - 0.57{]}). Full predictors can be seen in table \ref{tab:m5-int-fixef-exp-1}.
...
Two hundred and ninety-seven individuals participated in the present experiment. Of those 54\% identified as male (\emph{n} = 155). Table 3 shows the demographic information for Experiment 2. Furthering, table 4 illustrates a Bayesian correlational matrix of all the measures wherein content-based similar measures illustrated positive and negative correlations consistent with expectations. The average completion time for participants was 10.61 (\emph{SD} = 51.56)

In general, male participants were more likely to endorse dominance-oriented statements, (95\% CI b = -0.02, {[}-0.22 - 0.18{]}).
...
Following the previous basic results, we began our pre-regisetered analysis found in the pre-registration found on OSF.io. Dominance-oriented indvidiual was a strong predictor of multiple domains of risk-taking. Namely, participants that have a preference for both financial and social risk-taking, (95\% CI b = 0.38, {[}0.24 - 0.52{]}) and (95\% CI b = 0.20, {[}0.05 - 0.34{]}) respectively. Investigating gender differences and found that males with a preference for financial risk-taking were more likely to endorse dominant-oriented statements, (95\% CI b = -0.11, {[}-0.29 - 0.07{]}).

\hypertarget{prestige-1}{%
\paragraph{Prestige}\label{prestige-1}}

Differentiating between DoPL domains, males with a preference for social risk-taking were more likely to endorse prestige-oriented statements along with indivdiuals with a general preference for social risk-taking, (95\% CI b = 0.07, {[}-0.12 - 0.25{]}) and (95\% CI b = -0.12, {[}-0.27 - 0.02{]}) respectively.

\hypertarget{leadership-1}{%
\paragraph{Leadership}\label{leadership-1}}

Finally, leadership orientation follows a similar trend seen with dominance and prestige orientations. Males with a preference for social risk-taking were more likely to endorse leadership-oriented statements along with individuals with a less of a preference for recreational risk-taking endorsing leadership-oriented statements , (95\% CI b = 0.04, {[}-0.14 - 0.22{]}) and (95\% CI b = -0.01, {[}-0.13 - 0.12{]}) respectively.
...
{\centering \includegraphics[width=1\linewidth]{../Chapters/GraphsandTables/mediation1} 

}

\caption{Mediation Model for Experiment 2}\label{fig:MediationSEM1}
\end{figure}

Following the pre-registration on OSF.io we sought to replicate the findings of foster and colleagues which is demostrated in @ref\{fig:temp\} (\protect\hyperlink{ref-foster2009}{2009})

Following traditional Bayesian models, we analyzed relationships through a Bayesian mediation model using the brms Bayesian structural equation modeling software along with it's software to create a multilevel model (\protect\hyperlink{ref-burkner2017}{Bürkner, 2017}, \protect\hyperlink{ref-burkner2018}{2018}). Centralized in the model is risk preference. In this exploratory model we were investigating to see what the best predictor variable is the best mediatior in our analysis. Figure \ref{fig:MediationSEM1} represents our hypothetical model of dominance being the strongest mediator.

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{../Chapters/GraphsandTables/mediation2} 

}

\caption{Mediation Model for Experiment 2}\label{fig:MediationSEM2}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{../Chapters/GraphsandTables/mediation3} 

}

\caption{Mediation Model for Experiment 2}\label{fig:MediationSEM3}
\end{figure}

\includegraphics{Output_Files/DoPL-Experiment_files/figure-latex/unnamed-chunk-4-1.pdf}
...
{\centering \includegraphics{Output_Files/DoPL-Experiment_files/figure-latex/correlationPNIDoPL-1} 
...
\midrule
Intercept & 0.26 & 0.12 & 0.12 & 0.02 - 0.5\\
Dominance & 0.26 & 0.10 & 0.10 & 0.07 - 0.46\\
Gender & -0.55 & 0.16 & 0.16 & -0.87 - -0.23\\
\bottomrule
\addlinespace
\end{tabular}
...
\midrule
\endhead
DOSPERT Recreation Preference * Intercept & 0.33 & 0.12 & 0.12 & 0.11 - 0.56\\
DOSPERT Ethical Preference * Dominance & 0.42 & 0.08 & 0.08 & 0.26 - 0.58\\
DOSPERT Financial Preference * Dominance & 0.22 & 0.08 & 0.08 & 0.06 - 0.38\\
DOSPERT Social Preference * Dominance & 0.24 & 0.08 & 0.08 & 0.07 - 0.4\\
DOSPERT Social Preference * Gender & -0.39 & 0.18 & 0.18 & -0.75 - -0.03\\
DOSPERT Health and Safety Preference * Dominance & 0.37 & 0.08 & 0.08 & 0.21 - 0.53\\
DOSPERT Recreation Preference * Dominance & 0.47 & 0.08 & 0.08 & 0.32 - 0.62\\
DOSPERT Recreation Preference * Gender & -0.70 & 0.17 & 0.17 & -1.03 - -0.38\\
DOSPERT Recreation Preference * Age & 0.22 & 0.09 & 0.09 & 0.06 - 0.39\\
\bottomrule
\addlinespace
\insertTableNotes
\end{longtable}
...
\midrule
\endhead
DOSPERT Risk Likelihood * Intercept & 0.25 & 0.11 & 0.11 & 0.03 - 0.47\\
DOSPERT Risk Perception * Intercept & -0.25 & 0.13 & 0.13 & -0.5 - -0.01\\
DOSPERT Risk Benefit * Intercept & 0.26 & 0.12 & 0.12 & 0.01 - 0.5\\
DOSPERT Risk Likelihood * Dominance & 0.41 & 0.09 & 0.09 & 0.23 - 0.59\\
DOSPERT Risk Likelihood * Gender & -0.50 & 0.15 & 0.15 & -0.8 - -0.21\\
DOSPERT Risk Perception * Dominance & -0.28 & 0.10 & 0.10 & -0.49 - -0.08\\
DOSPERT Risk Perception * Gender & 0.45 & 0.17 & 0.17 & 0.12 - 0.77\\
DOSPERT Risk Benefit * Dominance & 0.26 & 0.10 & 0.10 & 0.08 - 0.46\\
DOSPERT Risk Benefit * Gender & -0.57 & 0.16 & 0.16 & -0.88 - -0.27\\
\bottomrule
\addlinespace
\insertTableNotes
\end{longtable}
...
\midrule
\endhead
DOSPERT Risk Likelihood * Dominance & 0.65 & 0.13 & 0.13 & 0.39 - 0.91\\
DOSPERT Risk Likelihood * Gender & -0.48 & 0.15 & 0.15 & -0.77 - -0.19\\
DOSPERT Risk Likelihood * Dominance : Gender & -0.49 & 0.18 & 0.18 & -0.84 - -0.14\\
DOSPERT Risk Perception * Dominance & -0.30 & 0.15 & 0.15 & -0.6 - -0.02\\
DOSPERT Risk Perception * Gender & 0.44 & 0.16 & 0.16 & 0.12 - 0.77\\
DOSPERT Risk Benefit * Dominance & 0.40 & 0.14 & 0.14 & 0.13 - 0.68\\
DOSPERT Risk Benefit * Gender & -0.56 & 0.16 & 0.16 & -0.88 - -0.25\\
\bottomrule
\addlinespace
\insertTableNotes
\end{longtable}
...
Parameter & \multicolumn{1}{c}{Estimate} & \multicolumn{1}{c}{Est.Error} & \multicolumn{1}{c}{Est.Error.1} & \multicolumn{1}{c}{CI (95\%)}\\
\midrule
Intercept & 0.75 & 0.19 & 0.19 & 0.38 - 1.11\\
Dominance & 0.33 & 0.08 & 0.08 & 0.17 - 0.49\\
...
\caption{\label{tab:unnamed-chunk-6}General Correlation Matrix | Experiment 2}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
...
\begin{tablenotes}
\item \textit{Note: } 
\item * denotes signficance level. 1 = Self-Sacrifing and Self-Enhancement, 2 = Grandiose Fantasy, 3 = Exploitativeness, 4 = Hiding the Self, 5 = Entitlement Rage, 6 = Devaluing, 7 = Contingent Self-Esteem, 8 = Vulnerability, 9 = Grandiosity , 10 = B-PNI , 11 = Prestige , 12 = Leadership, 13 = Dominance
\end{tablenotes}
\end{threeparttable}}
\end{table}
\end{landscape}
