...
Individuals aged 15-24 overall have been the group often with the largest increase of sexually transmitted infections, namely in the United States with 50\% of the group representing new cases (\(\cong\) 10 million cases each year) (\protect\hyperlink{ref-shannon2018}{Shannon \& Klausner, 2018}). Similar trends appear in both Scotland and England with gonorrhea being the most common sexually transmitted infection with individuals under the age of 25 being a predominant group (\protect\hyperlink{ref-publichealthengland2020}{Public Health England, 2020}; \protect\hyperlink{ref-publichealthscotland2020}{Public Health Scotland, 2020}) College students/aged individuals have also increased alcohol consumption which contributes to lowered inhibitions and increased risky sexual behavior. Because many are developing sexually including some living away from home for the first time, they are more likely to engage in sexual experimentation such as multiple sex partners and in some cases may not use protection such as a condom.
...
\caption{\label{tab:unnamed-chunk-10}Bayesian Correlation with 95\% Crediblility Intervals}
...
Following traditional Bayesian models, we analyzed relationships through a Bayesian mediation model using the blavaan Bayesian structural equation modeling software (\protect\hyperlink{ref-merkle2021}{Merkle et al., 2021}). Centralized in the model is risk preference. In this model
...
\leavevmode\vadjust pre{\hypertarget{ref-merkle2021}{}}%
Merkle, E. C., Fitzsimmons, E., Uanhoro, J., \& Goodrich, B. (2021). Efficient bayesian structural equation modeling in \emph{stan}. \emph{Journal of Statistical Software}, \emph{100}(6). \url{https://doi.org/10.18637/jss.v100.i06}
...
\leavevmode\vadjust pre{\hypertarget{ref-publichealthengland2020}{}}%
Public Health England. (2020). \emph{Sexually transmitted infections and screening for chlamydia in England, 2020}. 39.

\leavevmode\vadjust pre{\hypertarget{ref-publichealthscotland2020}{}}%
Public Health Scotland. (2020). \emph{Genital chlamydia and gonorrhoea infection in scotland: laboratory diagnoses 2010-2019 - genital chlamydia and gonorrhoea infection in scotland: laboratory diagnoses - publications - public health scotland}. \url{https://publichealthscotland.scot/publications/genital-chlamydia-and-gonorrhoea-infection-in-scotland-laboratory-diagnoses/genital-chlamydia-and-gonorrhoea-infection-in-scotland-laboratory-diagnoses-2010-2019/}
...
\leavevmode\vadjust pre{\hypertarget{ref-shannon2018}{}}%
Shannon, C. L., \& Klausner, J. D. (2018). The growing epidemic of sexually transmitted infections in adolescents: a neglected population. \emph{Current Opinion in Pediatrics}, \emph{30}(1), 137--143. \url{https://doi.org/10.1097/MOP.0000000000000578}
...
\begin{figure}
\centering
\includegraphics{Output_Files/Dissertation_files/figure-latex/DominanceExperiment1-1.pdf}
...
\caption{\label{tab:m1-int-fixef-exp-1}DOSPERT and DoPL Interaction: Experiment 1}
