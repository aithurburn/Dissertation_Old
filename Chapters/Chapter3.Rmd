...
* note on the early understandings of how narcissism was interpreted as being, i.e., a defense mechanism @yakeley2018

* continued lack of consensus on what consitutes narcissism @ackerman2017

    * Also the discussion of social dominance in regard to narcissistic personality disorder @ackerman2017
...
All relevant analyses were conducted in a Bayesian framework using the brms package [@burkner2018] along with the cmdstanr packages notes [@gabry2021]. In addition to the aforementioned packages, we used bayestestR, rstan, and papaja for further analysis and creation of this manuscript [@makowski2019; @standevelopmentteam2020; @aust2020]. 
