...
```{r MediationFit1, fig.align = "center", out.width = "100%", fig.cap = 'Figure represents a mediation model with Narcissism as the central mediator in the model.The outcome variables being risk likelihood.'}

graph_sem(fit1_exp_2)
```


```{r MediationFit2, fig.align = "center", out.width = "100%", fig.cap = 'Figure represents a mediation model with Narcissism and Dominance as the central mediators in a parallel model.The outcome variables being risk likelihood.'}

graph_sem(fit2_exp_2)
```


```{r MediationFit3, fig.align = "center", out.width = "100%", fig.cap = 'Figure represents a mediation model with Narcissism and Dominance as the moderator in a serial model.The outcome variables being risk likelihood.'}

graph_sem(fit3_exp_2)
```
...
MutateHDI::apa_modified(m4_exp_1, caption = "DOSPERT Benefit and Perception: Experiment 1", note = "Fixed effect results of Dominance, Prestige, and Leadership with gender interactions predicting the perceptions and benefits of risk.", land_scape = TRUE, longtable = TRUE)
```

```{r m4-perceivedRisk-Gender-exp-1}
MutateHDI::apa_modified(m4_int_exp_1, caption = "DOSPERT Benefit and Perception: Experiment 1", note = "Fixed effect results of Dominance, Prestige, and Leadership with gender interactions predicting the perceptions and benefits of risk.", land_scape = TRUE, longtable = TRUE)
```
