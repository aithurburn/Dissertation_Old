...
When investigating dominance, prestige, and leadership motivations with domain-specific risk-taking findings supported the common expectations in the literature. Table 5 shows the interactions with like CI values. Dominance overall explained the relationship between DoPL orientation and preference, specifically (95% CI b = `r printnum(m3_int_fixef_exp_1["Ethical Preference * Dominance", "Estimate"])`, [`r paste(m3_int_fixef_exp_1["Ethical Preference * Dominance", c("CI (95%)")], collapse = ", ")`], financial, b = `r printnum(m3_int_fixef_exp_1["Financial Preference * Dominance", "Estimate"])`, [`r paste(m3_int_fixef_exp_1["Financial Preference * Dominance", c("CI (95%)")], collapse = ", ")`], social, b = `r printnum(m3_int_fixef_exp_1["Social Preference * Dominance", "Estimate"])`, [`r paste(m3_int_fixef_exp_1["Social Preference * Dominance", c("CI (95%)")], collapse = ", ")`], health and safety, b = `r printnum(m3_int_fixef_exp_1["Health and Safety Preference * Dominance", "Estimate"])`, [`r paste(m3_int_fixef_exp_1["Health and Safety Preference * Dominance", c("CI (95%)")], collapse = ", ")`], and recreational, b = `r printnum(m3_int_fixef_exp_1["Recreational Preference * Dominance", "Estimate"])`, [`r paste(m3_int_fixef_exp_1["Recreational Preference * Dominance", c("CI (95%)")], collapse = ",")`]) respectively. Full interactions can be found in table 4. Participant age and gender also appeared to affect recreational preference (95% CI b = `r printnum(m3_int_fixef_exp_1["Recreational Preference * Gender", "Estimate"])`, [`r paste(m3_int_fixef_exp_1["Recreational Preference * Gender", c("CI (95%)")], collapse = ", ")`], b = `r printnum(m3_int_fixef_exp_1["Recreational Preference * Age", "Estimate"])`, [`r paste(m3_int_fixef_exp_1["Recreational Preference * Age", c("CI (95%)")], collapse = ", ")`]) respectively.
...
Risk preferences is generally made up of benefits and perceptions of risk. Outside of perceptions and benefits, dominance and males who are dominance oriented were the strongest predictors of likelihood in engaging in a risky situation (95% CI b = `r printnum(m5_int_fixef_exp_1["Risk * Dominance", "Estimate"])`, [`r paste(m5_int_fixef_exp_1["Risk * Dominance", c("CI (95%)")], collapse = ", ")`] and b = `r printnum(m5_int_fixef_exp_1["Risk * Dominance : Gender", "Estimate"])`, [`r paste(m5_int_fixef_exp_1["Risk * Dominance : Gender", c("CI (95%)")], collapse = ", ")`]). Dominance also appeared to be a strong predictor of perceiving more benefits of engaging in a risky situation (95% CI b = `r printnum(m5_int_fixef_exp_1["Risk Benefit * Dominance", "Estimate"])`, [`r paste(m5_int_fixef_exp_1["Risk Benefit * Dominance", c("CI (95%)")], collapse = ", ")`]) along with gender where males are more likely to perceive benefits (95% CI b = `r printnum(m5_int_fixef_exp_1["Risk Benefit * Gender", "Estimate"])`, [`r paste(m5_int_fixef_exp_1["Risk Benefit * Gender", c("CI (95%)")], collapse = ", ")`]).

Alternatiively, prestige appeared to be a stronger predictor of perceiving risks than others along with female participants and female participants that are higher in leadership orientation (95% CI b = `r printnum(m5_int_fixef_exp_1["Risk Perception * Prestige", "Estimate"])`, [`r paste(m5_int_fixef_exp_1["Risk Perception * Prestige", c("CI (95%)")], collapse = ", ")`], b = `r printnum(m5_int_fixef_exp_1["Risk Perception * Gender", "Estimate"])`, [`r paste(m5_int_fixef_exp_1["Risk Perception * Gender", c("CI (95%)")], collapse = ", ")`], and b = `r printnum(m5_int_fixef_exp_1["Risk Perception * Leadership : Gender", "Estimate"])`, [`r paste(m5_int_fixef_exp_1["Risk Perception * Leadership : Gender" , c("CI (95%)")], collapse = ", ")`]). Full predictors can be seen in table \@ref(tab:m5-int-fixef-exp-1). 
...
In general, male participants were more likely to endorse dominance-oriented statements, (95% CI b = `r printnum(m1_interaction_gender_fixef_exp_2["Dominance : Gender", "Estimate"])`, [`r paste(m1_interaction_gender_fixef_exp_2["Dominance : Gender", c("CI (95%)")])`]). 

<!-- Along with younger indvidiuals tending to also endorse dominant-oriented statements, (95% CI b = `r printnum(m1_interaction_gender_fixef_exp_2["Dominance * Age", "Estimate"])`, [`r paste(m1_interaction_gender_fixef_exp_2["Dominance * Age", c("CI (95%)")], collapse = ", ")`]).  -->

### Preregistered Analyses

#### Dominance

Following the previous basic results, we began our pre-regisetered analysis found in the pre-registration found on OSF.io. Dominance-oriented indvidiual was a strong predictor of multiple domains of risk-taking. Namely, participants that have a preference for both financial and social risk-taking, (95% CI b = `r printnum(m3_interaction_gender_fixef_exp_2["Financial Preference * Dominance", "Estimate"])`, [`r paste(m3_interaction_gender_fixef_exp_2["Financial Preference * Dominance", c("CI (95%)")], collapse = ", ")`]) and (95% CI b = `r printnum(m3_interaction_gender_fixef_exp_2["Social Preference * Dominance", "Estimate"])`, [`r paste(m3_interaction_gender_fixef_exp_2["Social Preference * Dominance", c("CI (95%)")], collapse = ", ")`]) respectively. Investigating gender differences and found that males with a preference for financial risk-taking were more likely to endorse dominant-oriented statements, (95% CI b = `r printnum(m3_interaction_gender_fixef_exp_2["Financial Preference * Dominance : Gender", "Estimate"])`, [`r paste(m3_interaction_gender_fixef_exp_2["Financial Preference * Dominance : Gender", c("CI (95%)")], collapse = ", ")`]).

#### Prestige 

Differentiating between DoPL domains, males with a preference for social risk-taking were more likely to endorse prestige-oriented statements along with indivdiuals with a general preference for social risk-taking, (95% CI b = `r printnum(m3_interaction_gender_fixef_exp_2["Social Preference * Prestige : Gender", "Estimate"])`, [`r paste(m3_interaction_gender_fixef_exp_2["Social Preference * Prestige : Gender", c("CI (95%)")], collapse = ", ")`]) and (95% CI b = `r printnum(m3_interaction_gender_fixef_exp_2["Social Preference * Prestige", "Estimate"])`, [`r paste(m3_interaction_gender_fixef_exp_2["Social Preference * Prestige", c("CI (95%)")], collapse = ", ")`]) respectively. 

#### Leadership

Finally, leadership orientation follows a similar trend seen with dominance and prestige orientations. Males with a preference for social risk-taking were more likely to endorse leadership-oriented statements along with individuals with a less of a preference for recreational risk-taking endorsing leadership-oriented statements , (95% CI b = `r printnum(m3_interaction_gender_fixef_exp_2["Social Preference * Leadership : Gender", "Estimate"])`, [`r paste(m3_interaction_gender_fixef_exp_2["Social Preference * Leadership : Gender", c("CI (95%)")], collapse = ", ")`]) and (95% CI b = `r printnum(m3_interaction_gender_fixef_exp_2["Recreational Preference * Leadership", "Estimate"])`, [`r paste(m3_interaction_gender_fixef_exp_2["Recreational Preference * Leadership", c("CI (95%)")], collapse = ", ")`]) respectively.
...
Overall, anecdotally dominance appears to explain the overall individual perceptions, benefits, and likelihood of risk judgments (95% CI b = `r printnum(m2_interaction_gender_fixef_exp_2["Risk Perception * Dominance", "Estimate"])`, [`r paste(m2_interaction_gender_fixef_exp_2["Risk Perception * Dominance", c("CI (95%)")], collapse = ", ")`]), (95% CI b = `r printnum(m2_interaction_gender_fixef_exp_2["Risk Benefit * Dominance", "Estimate"])`, [`r paste(m2_interaction_gender_fixef_exp_2["Risk Benefit * Dominance", c("CI (95%)")], collapse = ", ")`]), and (95% CI b = `r printnum(m2_interaction_gender_fixef_exp_2["Risk * Dominance", "Estimate"])`, [`r paste(m2_interaction_gender_fixef_exp_2["Risk * Dominance", c("CI (95%)")], collapse = ", ")`]) respectively. Similarly, when looking at further sub-categorizations of general risk preferences there does appear to be mainly a bias with regards to age, where younger individuals overall have a higher risk preference than their older counterparts.
...
bayestestR::print_md(mediation_comparison_exp_2, caption = "Experiment 2 | Mediation model comparison")
```
