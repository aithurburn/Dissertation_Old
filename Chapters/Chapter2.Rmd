...
All participants completed the dominance, leadership, and prestige scale [@suessenbach2019]. Empirically, men have generally been more dominance-oriented in their behavior [@rosenthal2012].Following the literature as well, dominant men tended to prefer risk more so  than women (95% CI b = `r printnum(m1_int_exp_1_fixef["Gender", "Estimate"])`,[`r paste0(m1_int_exp_1_fixef["Gender", c("CI (95%)")])`]). The marginal posterior distribution of each parameter is summarized in Table 1. Interestingly, older individuals tended to be more dominance-oriented than younger individuals. 

#### General Risk and DoPL

Further investigations, as previously mentioned investigated DoPL's interactions with general risk preference. As stated, domianance appears to be the strongest predictor of general risk preference (95% CI b = `r printnum(m1_int_exp_1_fixef["Dominance", "Estimate"])`, [`r printnum(m1_int_exp_1_fixef["Dominance", c("CI (95%)")])`]). Overall, younger individuals tended to have a stronger preference for risk (95% CI b = `r printnum(m1_int_exp_1_fixef["Age", "Estimate"])`, [`r printnum(m1_int_exp_1_fixef["Age", c("CI (95%)")])`]). Those that tended to be lower in leadership orientation also had a tendency to be more risk averse than their counterparts (95% CI b = `r printnum(m1_int_exp_1_fixef["Leadership", "Estimate"])`, [`r printnum(m1_int_exp_1_fixef["Leadership", c("CI (95%)")])`]). 
...
When investigating dominance, prestige, and leadership motivations with domain-specific risk-taking findings supported the common expectations in the literature. Table 5 shows the interactions with like CI values. Dominance overall explained the relationship between DoPL orientation and preference, specifically (95% CI b = `r printnum(m3_int_exp_1_fixef["DOSPERT Ethical Preferece * Dominance", "Estimate"])`, [`r printnum(m3_int_exp_1_fixef["DOSPERT Ethical Preferece * Dominance", c("CI (95%)")])`], financial, b = `r printnum(m3_int_exp_1_fixef["DOSPERT Financial Preference * Dominance", "Estimate"])`, [`r printnum(m3_int_exp_1_fixef["DOSPERT Financial Preference * Dominance", c("CI (95%)")])`], social, b = `r printnum(m3_int_exp_1_fixef["DOSPERT Social Preference * Dominance", "Estimate"])`, [`r printnum(m3_int_exp_1_fixef["DOSPERT Social Preference * Dominance", c("CI (95%)")])`], health and safety, b = `r printnum(m3_int_exp_1_fixef["DOSPERT Health and Safety Preference * Dominance", "Estimate"])`, [`r printnum(m3_int_exp_1_fixef["DOSPERT Health and Safety Preference * Dominance", c("CI (95%)")])`], and recreational, b = `r printnum(m3_int_exp_1_fixef["DOSPERT Recreation Preference * Dominance", "Estimate"])`, [`r printnum(m3_int_exp_1_fixef["DOSPERT Recreation Preference * Dominance", c("CI (95%)")], collapse = ",")`]) respectively. Full interactions can be found in table 4. Participant age and gender also appeared to affect recreational preference (95% CI b = `r printnum(m3_int_exp_1_fixef["DOSPERT Recreation Preference * Gender", "Estimate"])`, [`r printnum(m3_int_exp_1_fixef["DOSPERT Recreation Preference * Gender", c("CI (95%)")])`], b = `r printnum(m3_int_exp_1_fixef["DOSPERT Recreation Preference * Age", "Estimate"])`, [`r printnum(m3_int_exp_1_fixef["DOSPERT Recreation Preference * Age", c("CI (95%)")])`]) respectively.
...
Risk preferences is generally made up of benefits and perceptions of risk. Outside of perceptions and benefits, dominance and males who are dominance oriented were the strongest predictors of likelihood in engaging in a risky situation (95% CI b = `r printnum(m4_int_exp_1_fixef["DOSPERT Risk Likelihood * Dominance", "Estimate"])`, [`r printnum(m4_int_exp_1_fixef["DOSPERT Risk Likelihood * Dominance", c("CI (95%)")])`] and b = `r printnum(m4_int_exp_1_fixef["DOSPERT Risk Likelihood * Dominance : Gender", "Estimate"])`, [`r printnum(m4_int_exp_1_fixef["DOSPERT Risk Likelihood * Dominance : Gender", c("CI (95%)")])`]). Dominance also appeared to be a strong predictor of perceiving more benefits of engaging in a risky situation (95% CI b = `r printnum(m4_int_exp_1_fixef["DOSPERT Risk Benefit * Dominance", "Estimate"])`, [`r printnum(m4_int_exp_1_fixef["DOSPERT Risk Benefit * Dominance", c("CI (95%)")])`]) along with gender where males are more likely to perceive benefits (95% CI b = `r printnum(m4_int_exp_1_fixef["DOSPERT Risk Benefit * Gender", "Estimate"])`, [`r printnum(m4_int_exp_1_fixef["DOSPERT Risk Benefit * Gender", c("CI (95%)")])`]).

Alternatiively, prestige appeared to be a stronger predictor of perceiving risks than others along with female participants and female participants that are higher in leadership orientation (95% CI b = `r printnum(m4_int_exp_1_fixef["DOSPERT Risk Perception * Prestige", "Estimate"])`, [`r printnum(m4_int_exp_1_fixef["DOSPERT Risk Perception * Prestige", c("CI (95%)")])`], b = `r printnum(m4_int_exp_1_fixef["DOSPERT Risk Perception * Gender", "Estimate"])`, [`r printnum(m4_int_exp_1_fixef["DOSPERT Risk Perception * Gender", c("CI (95%)")])`], and b = `r printnum(m4_int_exp_1_fixef["DOSPERT Risk Perception * Leadership : Gender", "Estimate"])`, [`r printnum(m4_int_exp_1_fixef["DOSPERT Risk Perception * Leadership : Gender" , c("CI (95%)")])`]). Full predictors can be seen in table \@ref(tab:m5-int-fixef-exp-1). 
...
Overall, age was an effective predictor for both grandiose and vulnerable narcissism with younger indivdiuals tending towards being more narcissitic for both grandiose and vulnerable traits (95% CI b = `r printnum(pni_multi_dospert_int_fixef_exp_2_j["Grandiosity * Age", "Estimate"])`, [`r printnum(pni_multi_dospert_int_fixef_exp_2_j["Grandiosity * Age", c("CI Low", "CI High")])`]), and (95% CI b = `r printnum(pni_multi_dospert_int_fixef_exp_2_j["Vulnerability * Age", "Estimate"])`, [`r printnum(pni_multi_dospert_int_fixef_exp_2_j["Vulnerability * Age", c("CI Low", "CI High")])`]) respecitively. Preferences for financial and males with a recreational risk preference tended to express more vulnerable narcissism traits (95% CI b = `r printnum(pni_multi_dospert_int_fixef_exp_2_j["Vulnerability * Financial Preference", "Estimate"])`, [`r printnum(pni_multi_dospert_int_fixef_exp_2_j["Vulnerability * Financial Preference", c("CI Low", "CI High")], collapse = ",")`]) and (95% CI b = `r printnum(pni_multi_dospert_int_fixef_exp_2_j["Vulnerability * Gender", "Estimate"])`, [`r printnum(pni_multi_dospert_int_fixef_exp_2_j["Vulnerability * Gender", c("CI Low", "CI High")])`]) respectively.

### Interactions

```{r MediationSEM1, echo=FALSE, fig.cap="Mediation Model for Experiment 2", fig.align="center", out.width="100%"}
knitr::include_graphics("/Users/andrew/Library/CloudStorage/OneDrive-Personal/Documents/1_UoE/Research/PhD/Dissertation/Chapters/GraphsandTables/mediation1.png")
```

Following the pre-registration on OSF.io we sought to replicate the findings of foster and colleagues which is demostrated in \@ref{fig:MediationSEM1} [-@foster2009]. We then constructed a model of narcissism predicting risk benefits and risk likelihood. We then tested the mediation model of narcissism predicting risk likelihood through risk benefits. We found that like what was observed in the Foster and colleagues 2009 model demostrates that narcissism as a good predictor for risk likelihood. Observed beta coefficients can be seen in fig \@ref{fig:MediationFit1}.

Following the replication of the primary model above, we sought to investigate a parallel mediation model where narcissism and dominance are predict risk likelihood through risk benefits. The constructed model can be seen in figure \@ref{fig:MediationSEM2}. We found that narcissism and dominance were both good predictors of risk likelihood. Observed beta coefficients can be seen in figure \@ref{fig:MediationFit2} (suggesting a medium partial mediation $\beta$ = `r  printnum(mediation_brms_1_exp_2_fixef["DOSPERT Risk Likelihood * DOSPERT Risk Benefit", "Estimate"])` CI = `r  printnum(mediation_brms_1_exp_2_fixef["DOSPERT Risk Likelihood * DOSPERT Risk Benefit", "CI (95%)"])`.


```{r MediationSEM2, echo=FALSE, fig.cap="Mediation Model for Experiment 2", fig.align="center", out.width="100%"}
knitr::include_graphics("/Users/andrew/Library/CloudStorage/OneDrive-Personal/Documents/1_UoE/Research/PhD/Dissertation/Chapters/GraphsandTables/mediation2.png")
```



```{r MediationSEM3, echo=FALSE, fig.cap="Mediation Model for Experiment 2", fig.align="center", out.width="100%"}
knitr::include_graphics("/Users/andrew/Library/CloudStorage/OneDrive-Personal/Documents/1_UoE/Research/PhD/Dissertation/Chapters/GraphsandTables/mediation3.png")
```
