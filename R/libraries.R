...
m1 <- readRDS("./Dissertation/m1.rds")
m2 <- readRDS("./Dissertation/m2.rds")
m3 <- readRDS("./Dissertation/m3.rds")
m5 <- readRDS("./Dissertation/m5.rds")
m6 <- readRDS("./Dissertation/m6.rds")
m7 <- readRDS("./Dissertation/m7.rds")


m1_hdi <- readRDS("./Dissertation/m1_hdi.rds")
m2_hdi <- readRDS("./Dissertation/m2_hdi.rds")
m3_hdi <- readRDS("./Dissertation/m3_hdi.rds")
m4_hdi <- readRDS("./Dissertation/m4_hdi.rds")
m5_hdi <- readRDS("./Dissertation/m5_hdi.rds")
m6_hdi <- readRDS("./Dissertation/m6_hdi.rds")
m7_hdi <- readRDS("./Dissertation/m7_hdi.rds")
m1_hdi <- readRDS("./Dissertation/m1_hdi.rds")
m1_int <- readRDS("./Dissertation/m1_int.rds")
m1_int_d <- readRDS("./Dissertation/m1_int_d.rds")
m1_int_l <- readRDS("./Dissertation/m1_int_l.rds")
m1_int_p <- readRDS("./Dissertation/m1_int_p.rds")
m1_int_d_hdi <- readRDS("./Dissertation/m1_int_d_hdi.rds")
m1_int_l_hdi <- readRDS("./Dissertation/m1_int_l_hdi.rds")
m1_int_p_hdi <- readRDS("./Dissertation/m1_int_p_hdi.rds")
m7_DoPL_DOSPERT <- readRDS("./Dissertation/m7_DoPL_DOSPERT.rds")
m4_perceivedRisk_Age <- readRDS("./Dissertation/m4_perceivedRisk_Age.rds")
m5_generalRiskPreference <- readRDS("./Dissertation/m5_generalRiskPreference.rds")
m5_benefitRisk_Age <- readRDS("./Dissertation/m5_benefitRisk_Age.rds")
m4_perceivedRisk_Gender <- readRDS("./Dissertation/m4_perceivedRisk_Gender.rds")
m5_benefitRisk_Gender <- readRDS("./Dissertation/m5_benefitRisk_Gender.rds")
m7_DoPL_DOSPERT_hdi <- readRDS("./Dissertation/m7_DoPL_DOSPERT_hdi.rds")
m4_perceivedRisk_Age_hdi <- readRDS("./Dissertation/m4_perceivedRisk_Age_hdi.rds")
m5_generalRiskPreference_hdi <- readRDS("./Dissertation/m5_generalRiskPreference_hdi.rds")
m5_benefitRisk_Age_hdi <- readRDS("./Dissertation/m5_benefitRisk_Age_hdi.rds")
m4_perceivedRisk_Gender_hdi <- readRDS("./Dissertation/m4_perceivedRisk_Gender_hdi.rds")
m5_benefitRisk_Gender_hdi <- readRDS("./Dissertation/m5_benefitRisk_Gender_hdi.rds")
#load(".RData")
