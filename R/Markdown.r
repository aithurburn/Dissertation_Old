...
correlation_table <- read.csv("./CSV_Files/table_attempt.csv")
...
m1_int_d <- brm(generalRiskPreference ~ dominanceSum * Gender + prestigeSum + leadershipSum + Age,
  data = experiment_dataset_analysis,
  prior = c(
    prior(normal(0, 1), class = "Intercept"),
    prior(normal(3, 1), class = "b", coef = "dominanceSum"),
...
kable(m1_int_d_hdi[
  sign(m1_int_d_hdi$CI_low) == sign(m1_int_d_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
m1_int_l <- brm(generalRiskPreference ~ dominanceSum + prestigeSum + leadershipSum * Gender + Age,
  data = experiment_dataset_analysis,
  prior = c(
    prior(normal(0, 1), class = "Intercept"),
    prior(normal(3, 1), class = "b", coef = "dominanceSum"),
...
kable(m1_int_l_hdi[
  sign(m1_int_l_hdi$CI_low) == sign(m1_int_l_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
m1_int_p <- brm(generalRiskPreference ~ dominanceSum + prestigeSum * Gender + leadershipSum + Age,
  data = experiment_dataset_analysis,
  prior = c(
    prior(normal(0, 1), class = "Intercept"),
    prior(normal(3, 1), class = "b", coef = "dominanceSum"),
...
kable(m1_int_p_hdi[
  sign(m1_int_p_hdi$CI_low) == sign(m1_int_p_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
m2 <- brm(mvbind(ethicalPreference, financialPreference, socialPreference, healthAndSafetyPreference, recreationalPreference) ~ dominanceSum + prestigeSum + leadershipSum + Gender + Age,
  data = experiment_dataset_analysis, cores = 6,
  prior = c(
...
m6 <- brm(mvbind(ethicalPreference, financialPreference, socialPreference, healthAndSafetyPreference, recreationalPreference) ~ dominanceSum * Age + prestigeSum * Age + leadershipSum * Age + Age,
  data = experiment_dataset_analysis, cores = 6,
  prior = c(
    prior(normal(0, 1), coef = "Age", resp = "ethicalPreference"),
    prior(normal(2, 1), coef = "dominanceSum", resp = "ethicalPreference"),
...
kable(m3_int_gender_hdi_exp_2_j[
  sign(m3_int_gender_hdi_exp_2_j$CI_low) == sign(m3_int_gender_hdi_exp_2_j$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) 
...
m4 <- brm(mvbind(riskSum, riskPerceptionSum, riskBenefitSum) ~ dominanceSum + prestigeSum + leadershipSum + Age + Gender,
  ...
  ), save_all_pars = T, iter = 6500, cores = 6, warmup = 500
)
...
m5 <- brm(mvbind(riskSum, riskPerceptionSum, riskBenefitSum) ~ dominanceSum * Gender + prestigeSum * Gender + leadershipSum * Gender + Age,
  chains = 4, data = experiment_dataset_analysis, iter = 6000, cores = parallel::detectCores(), warmup = 500,
  prior = c(
    prior(normal(0, 1), class = "Intercept", resp = "riskSum"),
    prior(normal(0, 1), class = "sigma", resp = "riskSum"),
    prior(normal(-3, 1), coef = "Age", resp = "riskSum"),
    ...
    prior(normal(0, 1), coef = "Gender:leadershipSum", resp = "riskBenefitSum")
  ), save_all_pars = T
)
summary(m5)
...
m7 <- brm(mvbind(riskSum, riskPerceptionSum, riskBenefitSum) ~ dominanceSum * Age + prestigeSum * Age + leadershipSum * Age + Gender,
  data = experiment_dataset_analysis, iter = 4000, cores = 6,
  prior = c(
    prior(normal(0, 1), class = "Intercept", resp = "riskSum"),
    prior(normal(0, 1), class = "sigma", resp = "riskSum"),
    prior(normal(-3, 1), coef = "Age", resp = "riskSum"),
    ...
    prior(normal(0, 1), coef = "Age:leadershipSum", resp = "riskBenefitSum")
  ), save_all_pars = T
)
summary(m7)
...
kable(m7_hdi[
  sign(m7_hdi$CI_low) == sign(m7_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
library(brms)
demo_m1 <- brm(mvbind(dominanceSum, prestigeSum, leadershipSum) ~ Gender + Age,
...
priorTest <- c(
  prior(normal(0, 1), class = "b", resp = "ethicalPreference"),
...
m7_DoPL_DOSPERT <- brm(mvbind(dominanceSum, prestigeSum, leadershipSum) ~ ethicalPreference + financialPreference + socialPreference + healthAndSafetyPreference + recreationalPreference,
  data = experiment_dataset_analysis,
...
kable(m7_DoPL_DOSPERT_hdi[
  sign(m7_DoPL_DOSPERT_hdi$CI_low) == sign(m7_DoPL_DOSPERT_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
m4_perceivedRisk_Age <- brm(mvbind(ethicalQuestionsPerceptionSum, financialQuestionsPerceptionSum, socialQuestionsPerceptionSum, recreationalQuestionsPerceptionSum, healthAndSafetyQuestionsPerceptionSum) ~ dominanceSum * Age + prestigeSum * Age + leadershipSum * Age + Gender + Age,
...
kable(m4_perceivedRisk_Age_hdi[
  sign(m4_perceivedRisk_Age_hdi$CI_low) == sign(m4_perceivedRisk_Age_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
m5_generalRiskPreference <- brm(generalRiskPreference ~ ethicalPreference + socialPreference + financialPreference + healthAndSafetyPreference + recreationalPreference,
...
kable(m5_benefitRisk_Age_hdi[
  sign(m5_benefitRisk_Age_hdi$CI_low) == sign(m5_benefitRisk_Age_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
m4_perceivedRisk_Gender <- brm(mvbind(ethicalQuestionsPerceptionSum, financialQuestionsPerceptionSum, socialQuestionsPerceptionSum, recreationalQuestionsPerceptionSum, healthAndSafetyQuestionsPerceptionSum) ~ dominanceSum * Gender + prestigeSum * Gender + leadershipSum * Gender + Gender + Age,
  iter = 6000, warmup = 500,
  data = experiment_dataset_analysis,
  prior =
    c(
      prior(normal(0, 1), class = "Intercept", resp = "ethicalQuestionsPerceptionSum"),
...
kable(m4_perceivedRisk_Gender_hdi[
  sign(m4_perceivedRisk_Gender_hdi$CI_low) == sign(m4_perceivedRisk_Gender_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
kable(m5_benefitRisk_Gender_hdi[
  sign(m5_benefitRisk_Gender_hdi$CI_low) == sign(m5_benefitRisk_Gender_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
m8 <- brm(mvbind(
  ethicalQuestionsRiskSum, ethicalQuestionsPerceptionSum, ethicalQuestionsBenefitSum,
  ...
  socialQuestionsRiskSum, socialQuestionsPerceptionSum, socialQuestionsBenefitSum
) ~ dominanceSum * Gender + prestigeSum * Gender + leadershipSum * Gender + Age,
data = experiment_dataset_analysis, iter = 8000, warmup = 500, save_all_pars = T, cores = 6,
#----
prior = c(
  prior(normal(0, 1), class = "Intercept", resp = "ethicalQuestionsRiskSum"),
...
m8_hdi[
  sign(m8_hdi$CI_low) == sign(m8_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
]
...
q <- ggplot(
  data = experiment_1_Dataset_analysis,
  aes(
    x = dominanceSum,
    y = riskSum,
  ...
  theme_classic() +
  labs(
    title = "Linear Relationship for Risk Domains ",
    col = "Risk Domains"
  )
...
ggplot(
  ...
  theme_classic() +
  labs(
    title = "Linear Relationship for Risks Domainsfd ",
    col = "Risk Domains"
  )
...
ggplot_func <- function(dataset, xcol, ycol) {
  ...
  ggplot(data = {{ dataset }}, aes(x = {{ xcol }}, y = {{ ycol }}, color = as.factor(Gender))) +
    ...
    theme_classic() +
    labs(
      title = "Linear Relationship for Risk Domains: ", subtitle = titleName,
      col = "Risk Domains"
    )
...
for (i in df) {
  testPlot <- ggplot(
    ...
    theme_classic() +
    labs(
      title = "Linear Relationship for Risk Domains: ", subtitle = paste0({{ i }}),
      col = "Participant \n Gender"
    )
  ggsave(paste0("./R-output/ggplot/", {{ i }}, ".png"))
}
for (i in df) {
  ggplot_func(experiment_1_Dataset_analysis, dominanceSum, i)
}
...
m3 <- brm(mvbind(ethicalPreference, financialPreference, socialPreference, healthAndSafetyPreference, recreationalPreference) ~ dominanceSum * Gender + prestigeSum * Gender + leadershipSum * Gender + Age,
  data = experiment_dataset_analysis, save_all_pars = T, iter = 10000,
  prior(
    prior(normal(0, 1), coef = "Age", resp = "ethicalPreference"),
    prior(normal(0, 1), coef = "Gender", resp = "ethicalPreference"),
    prior(normal(2, 1), coef = "dominanceSum", resp = "ethicalPreference"),
...
m4_DoPL_J <- brm(mvbind(dominanceSum, prestigeSum, leadershipSum) ~ riskSum + riskPerceptionSum + riskBenefitSum + Age + Gender,
  data = experiment_dataset_analysis,
  prior = c(
    prior(normal(0, 1), class = "Intercept", resp = "dominanceSum"),
    prior(normal(0, 1), class = "sigma", resp = "dominanceSum"),
    ...
    prior(normal(3, 1), coef = "Gender1", resp = "leadershipSum"),
    ...
    prior(normal(-3, 1), coef = "Gender1", resp = "prestigeSum"),
    prior(normal(3, 1), coef = "riskSum", resp = "prestigeSum"),
    prior(normal(-2, 1), coef = "riskPerceptionSum", resp = "prestigeSum"),
    prior(normal(0, 1), coef = "riskBenefitSum", resp = "prestigeSum")
  ), save_all_pars = T, iter = 10000, cores = parallel::detectCores(), warmup = 500
)
...
# HDI
m4_DoPL_J_hdi <- bayestestR::hdi(m4_DoPL_J, effects = "fixed", component = "conditional", ci = .95)
kable(m4_DoPL_J_hdi[
  sign(m4_DoPL_J_hdi$CI_low) == sign(m4_DoPL_J_hdi$CI_high),
  c("Parameter", "CI", "CI_low", "CI_high")
], format = "html", booktabs = T, escape = F, longtable = F, digits = 2) %>%
  kable_styling(full_width = T) %>%
  remove_column(1)
...
# Benefit, perception and risk taking across subdomains for DOPL motives and interactions
m5 <- brm(mvbind(riskSum, riskPerceptionSum, riskBenefitSum) ~ dominanceSum * Gender + prestigeSum * Gender + leadershipSum * Gender + Age,
  data = experiment_dataset_analysis, iter = 6000, cores = 6, warmup = 500,
  prior = c(
    prior(normal(0, 1), class = "Intercept", resp = "riskSum"),
    prior(normal(0, 1), class = "sigma", resp = "riskSum"),
    prior(normal(-3, 1), coef = "Age", resp = "riskSum"),
    ...
    prior(normal(0, 1), coef = "GenderMale:leadershipSum", resp = "riskBenefitSum")
  ), save_all_pars = T
)
...
m7_DoPL_DOSPERT_Gender <- brm(mvbind(dominanceSum, prestigeSum, leadershipSum) ~ ethicalPreference * Gender + financialPreference * Gender + socialPreference * Gender + healthAndSafetyPreference * Gender + recreationalPreference * Gender,
  data = experiment_dataset_analysis,
  iter = 6500, warmup = 500,
  prior = c(
    prior(normal(0, 1), class = "Intercept"),
...
ggplot(d2, aes(x = variable, y = value, group = variable)) +
  geom_boxplot(outlier.color = "red", outlier.size = 2, outlier.shape = 16) +
  geom_point(position = "jitter") +
  theme_apa()

timing <- lm(Justification ~ Justification_overall_timing + (Vignettes), data = d1)

d2 <- read.csv("experiment_1_mean_timings.csv")

d2 <- d2 %>%
  pivot_longer(!X, names_to = "variable", values_to = "value")

m5 <- brm(mvbind(riskSum, riskPerceptionSum, riskBenefitSum) ~ ethicalPreference + financialPreference + socialPreference + healthAndSafetyPreference + recreationalPreference + Gender + Age,
  data = experiment_dataset_analysis, cores = parallel::detectCores(), iter = 10000, warmup = 500, save_pars = save_pars(all = TRUE), backend = "cmdstanr",
  prior = c(
    # Risk Benefit
    prior(normal(0, 1), class = "Intercept", resp = "riskBenefitSum"),
    prior(normal(0, 1), class = "sigma", resp = "riskBenefitSum"),
    prior(normal(0, 1), class = "b", coef = "Age", resp = "riskBenefitSum"),
    prior(normal(0, 1), class = "b", coef = "Gender", resp = "riskBenefitSum"),
    prior(normal(0, 1), class = "b", coef = "ethicalPreference", resp = "riskBenefitSum"),
    prior(normal(0, 1), class = "b", coef = "financialPreference", resp = "riskBenefitSum"),
    prior(normal(0, 1), class = "b", coef = "healthAndSafetyPreference", resp = "riskBenefitSum"),
    prior(normal(0, 1), class = "b", coef = "recreationalPreference", resp = "riskBenefitSum"),
    prior(normal(0, 1), class = "b", coef = "socialPreference", resp = "riskBenefitSum"),
    # Risk Perception
    prior(normal(0, 1), class = "Intercept", resp = "riskPerceptionSum"),
    prior(normal(0, 1), class = "sigma", resp = "riskPerceptionSum"),
    prior(normal(0, 1), class = "b", coef = "Age", resp = "riskPerceptionSum"),
    prior(normal(0, 1), class = "b", coef = "Gender", resp = "riskPerceptionSum"),
    prior(normal(0, 1), class = "b", coef = "ethicalPreference", resp = "riskPerceptionSum"),
    prior(normal(0, 1), class = "b", coef = "financialPreference", resp = "riskPerceptionSum"),
    prior(normal(0, 1), class = "b", coef = "healthAndSafetyPreference", resp = "riskPerceptionSum"),
    prior(normal(0, 1), class = "b", coef = "recreationalPreference", resp = "riskPerceptionSum"),
    prior(normal(0, 1), class = "b", coef = "socialPreference", resp = "riskPerceptionSum"),
    # Risk
    prior(normal(0, 1), class = "Intercept", resp = "riskSum"),
    prior(normal(0, 1), class = "sigma", resp = "riskSum"),
    prior(normal(0, 1), class = "b", coef = "Age", resp = "riskSum"),
    prior(normal(0, 1), class = "b", coef = "Gender", resp = "riskSum"),
    prior(normal(0, 1), class = "b", coef = "ethicalPreference", resp = "riskSum"),
    prior(normal(0, 1), class = "b", coef = "financialPreference", resp = "riskSum"),
    prior(normal(0, 1), class = "b", coef = "healthAndSafetyPreference", resp = "riskSum"),
    prior(normal(0, 1), class = "b", coef = "recreationalPreference", resp = "riskSum"),
    prior(normal(0, 1), class = "b", coef = "socialPreference", resp = "riskSum")
  )
)
