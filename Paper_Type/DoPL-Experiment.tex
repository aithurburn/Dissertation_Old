...
\caption{\label{tab:unnamed-chunk-3}Experiment 1: Participant Demographics}
...
We first investigated DoPL orientation on general risk preference (Figure 1). General risk preference was anecdotally explained by dominance orientation, participant gender, and participant age (see table 2). General distributions of dominance, prestige, and leadership then warrented further analysis. To investigate the interaction of power orientation and DOSPERT we followed the methods described in the DOSPERT scoring manual found on the official DOSPERT Scale website (\href{https://sites.google.com/a/decisionsciences.columbia.edu/dospert/scoring-instructions}{DOSPERT Scoring Instructions}). This involves calculating the alpha and beta coefficients and then from there calculating the overall preferences for each of the subdomains and the overall domains for general risk preference along with the perception and benefit preferences for risk.
...
Following these findings, we investigated the effect of DoPL on general risk preference and found that dominance overall predicted risk preference along with gender and age of the participant (Table @ref(tab:``m1-fixef Experiment1'')).
...
Two hundred eighty-nine individuals participated in the present experiment. Of those 54\% identified as male (\emph{n} = 155). Table 3 shows the demographic information for Experiment 2. Furthering, table 4 illustrates a Bayesian correlational matrix of all the measures wherein content-based similar measures illustrated positive and negative correlations consistent with expectations.
...
\begin{figure}
\centering
\includegraphics{DoPL-Experiment_files/figure-latex/DoPL-Experiment-1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{DoPL-Experiment_files/figure-latex/DominanceExperiment1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{DoPL-Experiment_files/figure-latex/PrestigeExperiment1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{DoPL-Experiment_files/figure-latex/LeadershipExperiment1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{DoPL-Experiment_files/figure-latex/DOSPERT-Preferences-GenderExperiment1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{DoPL-Experiment_files/figure-latex/DoPLDomainsExperiment2-1.pdf}
